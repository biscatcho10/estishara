                            ...
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{asset('Dashboard/assets/media/products/product9.jpg')}}" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{asset('Dashboard/assets/media/products/product13.jpg')}}" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{asset('Dashboard/')}}assets/media/products/product16.jpg" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{asset('Dashboard/')}}assets/media/products/product15.jpg" title="" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
